...
/**
 * Servlet implementation class acceptsupport
 */
@WebServlet("/Employee/acceptsupport")
public class accept_support_ticket extends HttpServlet {
		...
		Connection con=null;
			...
			try {
				DbConn db=new DbConn();
      			 con=(Connection) db.createConnection();

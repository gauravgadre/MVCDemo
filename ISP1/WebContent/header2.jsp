...
<%@page import="java.util.Arrays" %>
 <!-- ======= Header ======= -->
  <header id="header" style="height:72px;background-image: linear-gradient(45deg, #1de099, #1dc8cd);">
    <div class="container">

      <div id="logo"  class="pull-left">
        <h1><a href="index.jsp#intro" class="scrollto">ISP</a></h1>
      </div>

      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="index.jsp#intro">Home</a></li>
          <li><a href="index.jsp#about">About Us</a></li>
          <li><a href="index.jsp#pricing">Packages</a></li>
          <li><a href="index.jsp#faq">Services</a></li>
          <li><a href="index.jsp#team">Products</a></li>
             <li> <a href=""class="nav-link" class="btn btn-primary" data-toggle="modal" data-target="index.jsp#centralModalSm">Cart (      
           <%	    

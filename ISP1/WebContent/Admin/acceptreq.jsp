                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Accepted Support Request</h2>
...
try {
    ...
    ResultSet rs = stmt.executeQuery("select * from support_ticket where status='1' LIMIT "+(pageid-1)+","+total);
    while(rs.next())
    {
...
catch (Exception e)
{
	e.printStackTrace();
	 ...
	 stmt = (Statement) connection.createStatement();  
  ResultSet rs = stmt.executeQuery("select count(*) as record from support_ticket where status='1'");

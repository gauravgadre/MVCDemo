...
while(paramNames.hasMoreElements()) {
	...
	try{  
  			 ResultSet rs=ISPDao.get("customer_details where cemail='"+(String)session.getAttribute("cemail")+"'");
  			 if(rs.next()) {
...
parameters.put("MOBILE_NO",cphone);
parameters.put("EMAIL",cemail);
parameters.put("CALLBACK_URL", ISPDao.Port+"/pgResponse.jsp");
